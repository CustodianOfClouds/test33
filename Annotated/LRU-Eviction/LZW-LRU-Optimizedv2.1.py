#!/usr/bin/env python3
"""
LZW Compression Tool (Optimization 2.1: Output History + Offset/Suffix with O(1) HashMap)

Implements LZW compression with LRU (Least Recently Used) eviction policy.
This is OPTIMIZATION 2.1: Sends compact EVICT_SIGNAL using output history reference.
...
Usage:
    Compress:   python3 LZW-LRU-Optimizedv2.1.py compress input.txt output.lzw --alphabet ascii
    Decompress: python3 LZW-LRU-Optimizedv2.1.py decompress input.lzw output.txt
"""
...
def compress(input_file, output_file, alphabet_name, min_bits=9, max_bits=16):
    """
    Compress a file using LZW with OPTIMIZATION 2.1 (output history + offset/suffix).
    ...
    Output History Details (OPTIMIZATION 2.1):
    ...
    # OPTIMIZATION 2.1: Output history with O(1) HashMap lookup
        ...
        while True:
            ...
            if combined in dictionary:
                ...
                if output_code in evicted_codes:
                    ...
                    # OPTIMIZATION 2.1: Try O(1) HashMap lookup for prefix position in output history
                ...
                # OPTIMIZATION 2.1: Add current output to history with O(1) HashMap tracking
...
def decompress(input_file, output_file):
    """
    Decompress a file using OPTIMIZATION 2.1 (output history reconstruction).
